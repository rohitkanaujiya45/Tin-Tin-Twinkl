            ...
            <div className="leftrightcontainer"> 
                ...
                <div className='rightside'>
                     ...
                     <div style={{display:"flex",alignItems:"center",padding:"8px"}} className='clubcontainer'> 
                        <img src={clublogobig} style={{width:"130px",height:"50px",marginRight:"30px"}}></img>
                        <div >
                            <p>Save { Math.round(0.025 * +currentProduct.price)} with Mart</p>
                            <h3>Mart Price: {Math.round(+currentProduct.price - 0.025 * +currentProduct.price)}</h3>
                        </div>
                     </div>
