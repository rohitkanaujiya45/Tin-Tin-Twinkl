...
import { Box, Heading, HStack, Image, Menu, MenuButton, MenuItem, MenuList, Button, Input, color } from '@chakra-ui/react'
...
function LowerNavbar() {
  ...
  return (
    <div style={responsiveNav}>
      ...
      <div style={{ width: "100%" }}>
        {/* <HStack > */}
        <HStack spacing="2px" justify="flex-start" wrap="wrap" p={2}>
  ...
  bg="rgb(254, 0, 0)"
  color="white"
  _hover={{ bg: "rgb(200, 0, 0)", color: "white" }} // Hover styles
  _active={{ bg: "rgb(200, 0, 0)" }} // Active styles
  ...
  color="white"
  _hover={{ bg: "rgb(200, 0, 0)", color: "white" }} // Hover styles
  _active={{ bg: "rgb(254, 0, 0)" }} // Active styles
  as={Button} >
              GEAR
            </MenuButton>
            <MenuList>
  ...
  as={Button} >
          ...
          {/* <Box  bg='rgb(254,221,0)' fontSize="12px"> */}
